...
<body style="background: #fff3e1;">
	...
	<dl class="leftmenu">
		...
		<dd>
			...
			<ul class="menuson">
				<li><cite></cite><a href="UserInfo/userInfos.jsp" target="rightFrame">查看个人信息</a><i></i></li>
				<li><cite></cite><a href="UserInfo/pwd.jsp" target="rightFrame">修改密码</a><i></i></li>
			</ul>
		</dd>
		<dd>
			<div class="title">
			...
			<ul class="menuson">
				...
				<li><cite></cite><a href="tab.html" target="rightFrame">扩展</a><i></i></li>
			</ul>
		</dd>
	</dl>
